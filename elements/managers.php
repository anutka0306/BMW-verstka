<div class="managers">
    ...
    <div class="managers-slider">
        <div class="manager-slider-item">
            <div class="manager-slider-item__wrapper">
                <img src="images/manager1.png" alt="manager 1">
                <div class="manager-slider-title">
                    <p class="text-73">Шайхутдинов <br>Ильдар</p>
        ...
        <div class="manager-slider-item">
            <div class="manager-slider-item__wrapper">
                ...
                <div class="manager-slider-title">
                    <p class="text-73">Садовой <br>Василий</p>
        ...
        <div class="manager-slider-item">
            <div class="manager-slider-item__wrapper">
                ...
                <div class="manager-slider-title">
                    <p class="text-73">Антошкин <br>Николай</p>
                    <p class="text-74">Мастер-приёмщик</p>
                </div>
            </div>
        </div>
        <div class="manager-slider-item">
            <div class="manager-slider-item__wrapper">
                ...
                <div class="manager-slider-title">
                    <p class="text-73">Кащук <br>Сергей</p>
